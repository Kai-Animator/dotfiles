...
plugins=(git dirhistory thefuck vi-mode dotenv)
...
alias gitclean='git fetch origin --prune && git branch -vv | grep ': gone' | awk '{print $1}' | xargs git branch -d'
...
# bun completions
[ -s "/home/melkor/.bun/_bun" ] && source "/home/melkor/.bun/_bun"

# bun
export BUN_INSTALL="$HOME/.bun"
export CARGO_INSTALL="$HOME/.cargo"
export GO_INSTALL="$HOME/go"
export PATH="$BUN_INSTALL/bin:$CARGO_INSTALL/bin:$GO_INSTALL/bin:$PATH:"
